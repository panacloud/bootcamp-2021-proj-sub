...
[![License](https://img.shields.io/npm/l/checkme.svg)](https://github.com/RaoAkif/checkme/blob/master/package.json)
...
checkme/0.0.0 win32-x64 node-v14.17.1
...
_See code: [src/commands/add.ts](https://github.com/RaoAkif/checkme/blob/v0.0.0/src/commands/add.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/RaoAkif/checkme/blob/v0.0.0/src/commands/hello.ts)_
