...
console.clear();
let todo = [
    new itemtodo_1.itemtodo(1, "go for run"), new itemtodo_1.itemtodo(2, "eat fruits"),
    new itemtodo_1.itemtodo(3, "eat some healthy drinks", true), new itemtodo_1.itemtodo(4, "8 hours sleep", true)
];
