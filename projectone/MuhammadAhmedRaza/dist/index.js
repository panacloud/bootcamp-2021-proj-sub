...
let todos = [
    new todoItem_1.TodoItem(1, "Have breakfast"), new todoItem_1.TodoItem(2, "Get Shoes"),
    new todoItem_1.TodoItem(3, "Fuel Bike"), new todoItem_1.TodoItem(4, "Call Ali", true)
];
let collection = new jsonTodoCollection_1.JsonTodoCollection("Ahmed", todos);
