...
let todos = [
    new todoItem_1.TodoItem(1, "Eat Breakfast"), new todoItem_1.TodoItem(2, "Study Time"),
    new todoItem_1.TodoItem(3, "Eat Lunch"), new todoItem_1.TodoItem(4, "Pray Time"),
    new todoItem_1.TodoItem(5, "Snacks Time")
];
let collection = new jsonTodoCollection_1.JsonTodoCollection("Hunaiza", todos);
