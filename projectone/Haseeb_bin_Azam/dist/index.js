...
let todos = [
    ...
    new todoItem_1.TodoItem(2, "buy shoes"),
    new todoItem_1.TodoItem(3, "buy shirt"),
    new todoItem_1.TodoItem(4, "buy dffdd")
];
let collection = new jsonTodoCollection_1.JsonTodoCollection("haseeb", todos);
