...
let todos = [
    new todoItem_1.TodoItem(1, "Reading Book"),
    new todoItem_1.TodoItem(2, "Complete Bootcamp2021 Project One"),
    new todoItem_1.TodoItem(3, "Attend Class"),
    new todoItem_1.TodoItem(4, "Complete Graphic Design Projects"),
];
let collection = new jsonTodoCollection_1.JsonTodoCollection("Hadi Haider", todos);
