...
let todos = [new todoItem_1.TodoItem(1, "Pray Fajar", true),
    new todoItem_1.TodoItem(2, "Do ziker", true),
    new todoItem_1.TodoItem(3, "Recite Holy Quran", true),
    new todoItem_1.TodoItem(4, "Do Breakfast")
];
let collection = new jsonTodoCollection_1.JsonTodoCollection("Muhammad's", todos);
console.clear();
