...
let todos = [
    new todoItem_1.TodoItem(1, "Buy Afghani Tikka"), new todoItem_1.TodoItem(2, "Buy SHirt"),
    new todoItem_1.TodoItem(3, "Buy Coffee"), new todoItem_1.TodoItem(4, "Visit Hospital", true)
];
let collection = new jsonTodoCollection_1.JsonTodoCollection("Imran", todos);
