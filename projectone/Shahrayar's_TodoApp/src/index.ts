...
import { JsonTodoCollection } from "./jsondb";

let todos = [
  new TodoItem(1, "Go for walk"),
  new TodoItem(2, "Work on Project 1"),
  new TodoItem(3, "Meeting with Client"),  
];


let collection: TodoCollection = new JsonTodoCollection("Shahrayar", todos);
