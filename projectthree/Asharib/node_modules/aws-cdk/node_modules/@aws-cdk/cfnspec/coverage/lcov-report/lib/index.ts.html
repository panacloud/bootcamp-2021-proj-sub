...
<head>
    <title>Code coverage report for lib/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> index.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">795x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">792x</span>
<span class="cline-any cline-yes">792x</span>
<span class="cline-any cline-yes">625680x</span>
<span class="cline-any cline-yes">798x</span>
<span class="cline-any cline-yes">798x</span>
<span class="cline-any cline-yes">2106720x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">792x</span>
<span class="cline-any cline-yes">624100x</span>
...
export function resourceSpecification(typeName: string): schema.ResourceType {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ret) {
<span class="cstat-no" title="statement not covered" >    throw new Error(`No such resource type: ${typeName}`);</span>
  }
  return ret;
}
&nbsp;
...
export function propertySpecification(typeName: string, propertyName: string): schema.Property {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ret) {
<span class="cstat-no" title="statement not covered" >    throw new Error(`Resource ${typeName} has no property: ${propertyName}`);</span>
  }
  return ret;
}
&nbsp;
 ...
 */
export function <span class="fstat-no" title="function not covered" >scrutinizablePropertyNames(</span>resourceType: string, scrutinyTypes: schema.PropertyScrutinyType[]): string[] {
  const impl = <span class="cstat-no" title="statement not covered" >specification().ResourceTypes[resourceType];</span>
<span class="cstat-no" title="statement not covered" >  if (!impl) { <span class="cstat-no" title="statement not covered" >return []; </span>}</span>
&nbsp;
  const ret = <span class="cstat-no" title="statement not covered" >new Array&lt;string&gt;();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (const [propertyName, propertySpec] of Object.entries(impl.Properties || {})) {</span>
<span class="cstat-no" title="statement not covered" >    if (scrutinyTypes.includes(propertySpec.ScrutinyType || schema.PropertyScrutinyType.None)) {</span>
<span class="cstat-no" title="statement not covered" >      ret.push(propertyName);</span>
    }
  }
&nbsp;
 ...
 */
export function <span class="fstat-no" title="function not covered" >scrutinizableResourceTypes(</span>scrutinyTypes: schema.ResourceScrutinyType[]): string[] {
  const ret = <span class="cstat-no" title="statement not covered" >new Array&lt;string&gt;();</span>
<span class="cstat-no" title="statement not covered" >  for (const [resourceType, resourceSpec] of Object.entries(specification().ResourceTypes)) {</span>
<span class="cstat-no" title="statement not covered" >    if (scrutinyTypes.includes(resourceSpec.ScrutinyType || schema.ResourceScrutinyType.None)) {</span>
<span class="cstat-no" title="statement not covered" >      ret.push(resourceType);</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return ret;</span>
